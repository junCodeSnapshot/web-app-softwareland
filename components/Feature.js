...
const Feature = () => {
    const features = [
        { id: 1, img: "./assets/future.jpg", title: "Design your future", desc: "We guide you to the future that you want", link: "/" },
        { id: 2, img: "./assets/coach.webp", title: "Perform as never before", desc: "You can train with our professional team of trainers every day!", link: "/" },
    ];
    return (
